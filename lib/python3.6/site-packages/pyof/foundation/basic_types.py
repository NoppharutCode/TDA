...
class TypeList(list, GenericStruct):
    ...
    def unpack(self, buff, item_class, offset=0 ,pyof_class_tee=None):
        ...
        while begin < limit_buff:
            ...
            """ edit tee start """
            if type(item).__name__  == "ActionHeader" :

                if item.action_type == 0 and item.length != 0:
                    
                    actionOutputItem = pyof_class_tee()
                    actionOutputItem.unpack(buff, begin)
                    self.append(actionOutputItem)
...
class FixedTypeList(TypeList):
    ...
    def __init__(self, pyof_class, items=None, pyof_class_tee=None):
        ...
        self._pyof_class_tee = pyof_class_tee
    ...
    def unpack(self, buff, offset=0):
        ...
        Args:
            ...
            offset (int): If we need to shift the beginning of the data.
        """
        super().unpack(buff, self._pyof_class, offset, self._pyof_class_tee)
