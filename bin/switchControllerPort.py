...
class Switch(threading.Thread):
    ...
    def sendAndReceiveOF_FEATURE_OPENFLOWV1(self, checkData, tempBytes ):
        ...
        try : 
            ...
            dictPort , tempHwAddr = self.getPortFromSnmpVersion2C( 0 )
            ...
            listPort.append(PPort(65534, '00:00:00:00:00:00','controller', 0, 0, 192 ,0,0,0))
    ...
    def openflowV1(self):
        ...
        while(1):
            ...
            if len(self.dictRemoteSwitchDataFromPort) == 0 :
                print("send OFPT_ECHO_REQUEST")
                packet = echoRequest().pack()
                self.s.send(packet)                   
